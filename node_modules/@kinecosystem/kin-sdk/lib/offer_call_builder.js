...
var OfferCallBuilder = exports.OfferCallBuilder = function (_CallBuilder) {
    ...
    function OfferCallBuilder(serverUrl, headers, retry, resource) {
        _classCallCheck(this, OfferCallBuilder);

        var _this = _possibleConstructorReturn(this, (OfferCallBuilder.__proto__ || Object.getPrototypeOf(OfferCallBuilder)).call(this, serverUrl, headers, retry));

        if (resource === 'accounts') {
            for (var _len = arguments.length, resourceParams = Array(_len > 4 ? _len - 4 : 0), _key = 4; _key < _len; _key++) {
                resourceParams[_key - 4] = arguments[_key];
            }
