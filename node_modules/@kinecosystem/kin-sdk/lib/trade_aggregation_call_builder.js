...
var TradeAggregationCallBuilder = exports.TradeAggregationCallBuilder = function (_CallBuilder) {
    ...
    function TradeAggregationCallBuilder(serverUrl, headers, retry, base, counter, start_time, end_time, resolution, offset) {
        _classCallCheck(this, TradeAggregationCallBuilder);

        var _this = _possibleConstructorReturn(this, (TradeAggregationCallBuilder.__proto__ || Object.getPrototypeOf(TradeAggregationCallBuilder)).call(this, serverUrl, headers, retry));
