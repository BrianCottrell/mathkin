...
var TradesCallBuilder = exports.TradesCallBuilder = function (_CallBuilder) {
    ...
    function TradesCallBuilder(serverUrl, headers, retry) {
        _classCallCheck(this, TradesCallBuilder);

        var _this = _possibleConstructorReturn(this, (TradesCallBuilder.__proto__ || Object.getPrototypeOf(TradesCallBuilder)).call(this, serverUrl, headers, retry));
