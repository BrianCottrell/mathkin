...
var OperationCallBuilder = exports.OperationCallBuilder = function (_CallBuilder) {
    ...
    function OperationCallBuilder(serverUrl, headers, retry) {
        _classCallCheck(this, OperationCallBuilder);

        var _this = _possibleConstructorReturn(this, (OperationCallBuilder.__proto__ || Object.getPrototypeOf(OperationCallBuilder)).call(this, serverUrl, headers, retry));
