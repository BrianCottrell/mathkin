...
var PathCallBuilder = exports.PathCallBuilder = function (_CallBuilder) {
    ...
    function PathCallBuilder(serverUrl, headers, retry, source, destination, destinationAsset, destinationAmount) {
        _classCallCheck(this, PathCallBuilder);

        var _this = _possibleConstructorReturn(this, (PathCallBuilder.__proto__ || Object.getPrototypeOf(PathCallBuilder)).call(this, serverUrl, headers, retry));
