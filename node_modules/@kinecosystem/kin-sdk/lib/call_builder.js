...
var CallBuilder = function () {
  function CallBuilder(serverUrl) {
    ...
    var retry = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    ...
    this.retry = Object.assign(_config.Config.getRetry(), retry);
  ...
  _createClass(CallBuilder, [{
    ...
    value: function _sendNormalRequest(url) {
      ...
      return axios.get(url.toString(), { headers: this.headers }).then(function (response) {
