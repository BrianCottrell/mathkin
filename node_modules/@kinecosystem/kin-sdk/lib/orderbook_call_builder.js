...
var OrderbookCallBuilder = exports.OrderbookCallBuilder = function (_CallBuilder) {
    ...
    function OrderbookCallBuilder(serverUrl, headers, retry, selling, buying) {
        _classCallCheck(this, OrderbookCallBuilder);

        var _this = _possibleConstructorReturn(this, (OrderbookCallBuilder.__proto__ || Object.getPrototypeOf(OrderbookCallBuilder)).call(this, serverUrl, headers, retry));
