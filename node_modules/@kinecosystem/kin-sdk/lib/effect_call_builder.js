...
var EffectCallBuilder = exports.EffectCallBuilder = function (_CallBuilder) {
    ...
    function EffectCallBuilder(serverUrl, headers, retry) {
        _classCallCheck(this, EffectCallBuilder);

        var _this = _possibleConstructorReturn(this, (EffectCallBuilder.__proto__ || Object.getPrototypeOf(EffectCallBuilder)).call(this, serverUrl, headers, retry));
