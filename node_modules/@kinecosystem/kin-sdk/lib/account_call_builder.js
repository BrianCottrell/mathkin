...
var AccountCallBuilder = exports.AccountCallBuilder = function (_CallBuilder) {
  ...
  function AccountCallBuilder(serverUrl, headers, retry) {
    _classCallCheck(this, AccountCallBuilder);

    var _this = _possibleConstructorReturn(this, (AccountCallBuilder.__proto__ || Object.getPrototypeOf(AccountCallBuilder)).call(this, serverUrl, headers, retry));
