...
var AssetsCallBuilder = exports.AssetsCallBuilder = function (_CallBuilder) {
    ...
    function AssetsCallBuilder(serverUrl, headers, retry) {
        _classCallCheck(this, AssetsCallBuilder);

        var _this = _possibleConstructorReturn(this, (AssetsCallBuilder.__proto__ || Object.getPrototypeOf(AssetsCallBuilder)).call(this, serverUrl, headers, retry));
