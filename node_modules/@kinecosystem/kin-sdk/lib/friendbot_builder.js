...
var FriendbotBuilder = exports.FriendbotBuilder = function (_CallBuilder) {
    ...
    function FriendbotBuilder(url, headers, retry, address) {
        _classCallCheck(this, FriendbotBuilder);

        var _this = _possibleConstructorReturn(this, (FriendbotBuilder.__proto__ || Object.getPrototypeOf(FriendbotBuilder)).call(this, url, headers, retry));
