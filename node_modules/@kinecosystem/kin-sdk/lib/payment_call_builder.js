...
var PaymentCallBuilder = exports.PaymentCallBuilder = function (_CallBuilder) {
     ...
     */
    function PaymentCallBuilder(serverUrl, headers, retry) {
        _classCallCheck(this, PaymentCallBuilder);

        var _this = _possibleConstructorReturn(this, (PaymentCallBuilder.__proto__ || Object.getPrototypeOf(PaymentCallBuilder)).call(this, serverUrl, headers, retry));
