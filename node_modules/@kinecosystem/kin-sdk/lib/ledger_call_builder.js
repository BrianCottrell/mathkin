...
var LedgerCallBuilder = exports.LedgerCallBuilder = function (_CallBuilder) {
    ...
    function LedgerCallBuilder(serverUrl, headers, retry) {
        _classCallCheck(this, LedgerCallBuilder);

        var _this = _possibleConstructorReturn(this, (LedgerCallBuilder.__proto__ || Object.getPrototypeOf(LedgerCallBuilder)).call(this, serverUrl, headers, retry));
