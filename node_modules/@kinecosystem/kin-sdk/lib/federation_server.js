...
var _kinBase = require('@kinecosystem/kin-base');
...
var FederationServer = exports.FederationServer = function () {
  ...
  _createClass(FederationServer, [{
    ...
    value: function _sendRequest(url) {
      ...
      return _axios2.default.get(url.toString(), { maxContentLength: FEDERATION_RESPONSE_MAX_SIZE, timeout: timeout, headers: this.headers }).then(function (response) {
