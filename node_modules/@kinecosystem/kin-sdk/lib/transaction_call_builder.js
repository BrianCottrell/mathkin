...
var TransactionCallBuilder = exports.TransactionCallBuilder = function (_CallBuilder) {
    ...
    function TransactionCallBuilder(serverUrl, headers, retry) {
        _classCallCheck(this, TransactionCallBuilder);

        var _this = _possibleConstructorReturn(this, (TransactionCallBuilder.__proto__ || Object.getPrototypeOf(TransactionCallBuilder)).call(this, serverUrl, headers, retry));
